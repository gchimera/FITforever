...
#import "LearnMoreF15ViewController.h"
#import "InitialViewController.h"

@interface LearnMoreF15ViewController ()

@end

@implementation LearnMoreF15ViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationItem setTitle:[self localisedStringForSection:CONTENT_LEARN_MORE_SECTION andKey:CONTENT_F15_PROGRAM_NAME]];
    ...
    [self languageAndLabelUIUpdate:self.learnMoreTagline inSection:CONTENT_LEARN_MORE_SECTION forKey:CONTENT_F15_PROGRAM_TAGLINE];
    [self languageHTMLLabelUIUpdate:self.learnMoreF15Description inSection:CONTENT_LEARN_MORE_SECTION forKey:CONTENT_F15_PROGRAM_DESCRIPTION];
}
