...
#import "LearnMoreV5ViewController.h"
#import "InitialViewController.h"

@interface LearnMoreV5ViewController ()

@end

@implementation LearnMoreV5ViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self.navigationItem setTitle:[self localisedStringForSection:CONTENT_LEARN_MORE_SECTION andKey:CONTENT_V5_PROGRAM_NAME]];
    ...
    [self languageAndLabelUIUpdate:self.learnMoreTagline inSection:CONTENT_LEARN_MORE_SECTION forKey:CONTENT_V5_PROGRAM_TAGLINE];
    [self languageHTMLLabelUIUpdate:self.learnMoreV5Description inSection:CONTENT_LEARN_MORE_SECTION forKey:CONTENT_V5_PROGRAM_DESCRIPTION];
}
