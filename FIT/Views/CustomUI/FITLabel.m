     ...
     limitedToNumberOfLines:(NSInteger)numberOfLines
{
    ...
    if (textSize.height < textRect.size.height)
    {
        ...
        {
            case FITLabelVerticalAlignmentCenter:
                yOffset = CGFloat_floor((bounds.size.height - textSize.height) / 2.0f);
                break;
            case FITLabelVerticalAlignmentBottom:
                yOffset = bounds.size.height - textSize.height;
                break;
            case FITLabelVerticalAlignmentTop:
            default:
                break;
        }
...
{
    FITLabel *label = [[FITLabel alloc] initWithFrame:CGRectMake(0.0, 0.0, size.width, size.height)];
    label.font = font;
